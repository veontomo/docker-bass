...
RUN apk add lsof openjdk8-jre && mkdir /opt/solr && cd /opt/solr && wget https://downloads.apache.org/lucene/solr/8.10.0/solr-8.10.0.tgz && tar zxf solr-8.10.0.tgz && rm solr-8.10.0.tgz 
